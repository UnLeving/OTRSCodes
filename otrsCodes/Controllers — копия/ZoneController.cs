...
namespace otrsCodes.Controllers
{
    public class ZoneController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Zone,CountryId")] Zone zones)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Zone,CountryId")] Zone zones)
        {
            if (ModelState.IsValid)
            {
