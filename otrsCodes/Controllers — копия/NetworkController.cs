...
namespace otrsCodes.Controllers
{
    public class NetworkController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            Network networks = db.Networks.Find(id);
            if (networks == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "Id,CountryId,ColorId,Name")] Network networks)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CountryId,ColorId,Name")] Network networks)
        {
            if (ModelState.IsValid)
            {
