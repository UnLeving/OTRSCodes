...
namespace otrsCodes.Controllers
{
    public class CodeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CountryId,NetworkId,Code")] Code codes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CountryId,NetworkId,Code")] Code codes)
        {
            if (ModelState.IsValid)
            {
